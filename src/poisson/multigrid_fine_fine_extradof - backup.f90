         ...
         do igrid_mg=1,ngrid,nvector
            ...
            do i=1,nbatch
               ...
               if(flag2(icell_amr(i))/ngridmax==0) then
                  ...
                  ! Chr 30/03/20
                  eta = rv*eta + qv*1.5d0*Ia*omega_m*aexp*(rho(icell_amr(i))-rho_tot)
                  eta = pv**2 + 8.0D0/3.0D0*rv*eta
                  ...
                  if((pv/rv)>=0.0d0) then
                     ! derived form Eq.(69)
                     op = op-(0.75d0*(-(pv)+dsqrt(eta))/rv-sf_src_mean)*dx2
         ...
         do igrid_mg=1,ngrid,nvector
            ...
            do i=1,nbatch
               ...
               if(flag2(icell_amr(i))/ngridmax==0) then
                  ...
                  if((pv/rv)>=0.0d0) then
                     ! derived form Eq.(69)
                     sf_src(icell_amr(i)) = 0.75d0*(-(pv)+dsqrt(eta))/rv
                     op = op - (0.75d0*(-(pv)+dsqrt(eta))/rv-sf_src_mean)*dx2
