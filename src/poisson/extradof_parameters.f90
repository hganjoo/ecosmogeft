module extradof_parameters
  ...
  logical  :: nDGP2=.true.       ! set to true to do nDGP with LCDM background, false for nDGP with a cosmological constant

  ! speed of light [meter/sec]
  real(dp) :: sol=299792458.0d0

  integer  :: ngs_fine_extradof_pre   = 5  ! pre-smoothing factor
  integer  :: ngs_fine_extradof_pst   = 5   ! post-smoothing factor
  integer  :: ngs_coarse_extradof_pre = 5  ! pre-smoothing factor
  integer  :: ngs_coarse_extradof_pst = 5   ! post-smoothing factor
